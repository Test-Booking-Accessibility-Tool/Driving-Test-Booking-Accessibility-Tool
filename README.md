...
Accessibility-focused browser tool for repetitive driving test date checking.

---

## Important Notice

⚠️ This tool is not affiliated with GOV.UK or DVSA.

The DVSA may regard tools of this type as contrary to their Terms & Conditions.
...
✅ Alerts when a date appears within your selected range  
✅ Accessibility-focused for repetitive checking  
✅ Works with Chrome  
✅ Manual booking only  
✅ Security wall detection  
✅ Audible alarms
...
## Pin the Extension (IMPORTANT)

1. Click the puzzle piece icon
2. Find Test Booking Accessibility Tool
...
1. Login to GOV.UK normally
2. Reach:

"Please choose one of the test centres below"
...
Complete it manually and restart monitoring.
...
No automatic booking takes place.
Use entirely at your own risk.
